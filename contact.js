export async function onRequestPost({ request, env }) {
  ...
  // Honeypot: real people leave this empty. Pretend success so bots do not retry.
  ...
  const res = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      from: env.MAIL_FROM,          // e.g. "Kingdom Way site <website@kingdomwayenterprises.com>"
      to: [env.MAIL_TO],            // your Zoho inbox — set as a secret, never in the page
      reply_to: email,
